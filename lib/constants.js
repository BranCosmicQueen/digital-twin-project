...
export const AISLE_WIDTH = 3.0;    // Pasillos grúas (Ajustado a 3m max)
export const RACK_PITCH = 5.4;     // RACK_DEPTH + AISLE_WIDTH (2.4 + 3.0)
...
export const GUARDHOUSE_Z = 20; // Pegado al muro, al lado del portón
