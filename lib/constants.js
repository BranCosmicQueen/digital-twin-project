...
// Staging Inbound (X: 56→60, Z: 10→30)
...
// Staging Outbound (X: 56→60, Z: 30→50)
...
export const AISLE_WIDTH = 2.6;    // Pasillos grúas (Ajustado al gap real de 2.6m)
export const RACK_PITCH = 5.0;     // Distancia entre centros (RACK_DEPTH + AISLE_WIDTH)
export const LEVELS = [0.15, 2.35, 4.55, 6.75, 8.95, 11.0]; 
...
export const GUARDHOUSE_Z = 18.5; // Ajustado para no chocar con el portón (que inicia en Z:20)
export const GUARDHOUSE_WIDTH = 4;
export const GUARDHOUSE_DEPTH = 3;
...
export const RESPEL_CENTER_X = 95;
export const RESPEL_CENTER_Z = 5;
export const RESPEL_SIZE_X = 8;
export const RESPEL_SIZE_Z = 6;
...
export const TRUCK_CAB_HEIGHT = 3.2;
export const TRUCK_TRAILER_LENGTH = 13.5;
export const TRUCK_TRAILER_HEIGHT = 4.0;
export const TRUCK_WIDTH = 2.6;
export const TRUCK_WHEEL_RADIUS = 0.55; // Sincronizado para piso de tráiler a 1.2m
