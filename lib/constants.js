...
export const GUARDHOUSE_WIDTH = 3;
export const GUARDHOUSE_DEPTH = 5;

// ── Romana de Pesaje (X:80, Z:6) — Interna al Patio de Maniobras ──
export const ROMANA_X = 80;
export const ROMANA_Z = 6;
...
export const RESPEL_SIZE = 10; // 10x10m (X:85-95, Z:0-10)
